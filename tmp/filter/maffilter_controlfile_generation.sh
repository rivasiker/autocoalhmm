...
echo "maf.filter=Subset(species=($2, $3, $4, $5), strict=yes, keep=no, remove_duplicates=yes, verbose=no), \\" >> ../control_file
echo "XFullGap(species=($2, $3, $4, $5), verbose=no), \\" >> ../control_file
